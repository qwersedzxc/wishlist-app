...
-- Description: Insert sample data for testing (optional)
-- Created: 2024-01-04
...
INSERT INTO wishlists (user_id, title, description, event_type, event_date, privacy) VALUES
(1, 'Мой день рождения 2024', 'Буду рад любому подарку из списка!', 'birthday', '2024-06-15', 'public'),
(2, 'Новый год 2025', 'Подарки к Новому году для всей семьи', 'new_year', '2024-12-31', 'public'),
(3, 'Свадьба', 'Список подарков к нашей свадьбе', 'wedding', '2024-08-20', 'public')
...
-- Insert gift ideas with proper UTF-8 encoding
...
VALUES ('004', 'Insert sample data for testing')
