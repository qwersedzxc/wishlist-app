# Информация о проекте Wishlist Service

# Описание

Wishlist Service - это полнофункциональная социальная платформа для создания и управления списками желаемых подарков. Пользователи могут создавать вишлисты к различным событиям, делиться ими с друзьями, резервировать подарки и получать рекомендации.
