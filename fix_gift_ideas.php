<?php
// Скрипт для исправления идей подарков - удаление поломанных данных и добавление новых

require_once __DIR__ . '/config/db.php';

echo "=== Исправление идей подарков ===\n\n";
...
try {
    ...
    $db->exec("DELETE FROM gift_ideas");
    ...
    $stmt = $db->prepare("INSERT INTO gift_ideas (title, description, category, price_range, image_url, url) VALUES (?, ?, ?, ?, ?, ?)");
    ...
    echo "\n✓ Идеи подарков успешно обновлены!\n";
    echo "Добавлено " . count($giftIdeas) . " идей подарков.\n\n";
